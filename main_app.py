...
numbers = input(Fore.LIGHTBLUE_EX+"Please enter your list of numbers as comma seperated values (csv): ")
...
# below we are just printing the list
# The syntax: for any_name in my_list_name
for item in numbers_list:
    print(item)

# Part 2: Ask the user about what formula (operation) they want to do with list:
# 1 for total
# 2 for average (the mean)
# 3 for max
# 4 for min

# We need to give an initial value of formula
formula = 0
while (formula!=5):
    ...
    # The solutions:
    # First solution: to convert the string into int inistently in the same line using int() function/method
    ...
    if formula==1:
        ...
        # in ohter word, the function block has to be placed before calling it
